...
| F07 | Backend API System | server | Partial / Connection Reviewed | Struktur server, scope API, dan koneksi frontend-backend sudah direview, tetapi backend belum dijadikan sumber data utama production. | F07-CP — Backend API System Checkpoint | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
