...
| F07 | Backend API System | server | Partial / Blocked | Checkpoint F07, F07E, F07G selesai. Database Prisma siap, panduan docker tersedia, tetapi tahap uji coba runtime F07H diblokir karena Docker daemon mati di host. | Hidupkan Docker / Validasi mandiri | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
