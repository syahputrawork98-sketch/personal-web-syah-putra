...
| F05 | CV Download System | frontend/assets | HOLD | File PDF CV final belum tersedia | F05A — Add Final CV PDF Assets | [F05_CV_DOWNLOAD_SYSTEM.md](features/F05_CV_DOWNLOAD_SYSTEM.md) |
| F06 | Asset Link and Preview System | frontend/data | HOLD / Partial | URL asli untuk Drive, Figma, RAB, demo, dan 3D preview belum lengkap atau belum diverifikasi public access | F06A — Final External Asset URL Input | [F06_ASSET_LINK_PREVIEW_SYSTEM.md](features/F06_ASSET_LINK_PREVIEW_SYSTEM.md) |
