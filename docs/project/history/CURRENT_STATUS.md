...
| F15 | HRD Portfolio Score Improvement | frontend/content | Completed | SEO static snapshot and recruiter readability baseline completed. | F15D — Experience Timeline Polish | [F15_HRD_PORTFOLIO_SCORE_IMPROVEMENT.md](features/F15_HRD_PORTFOLIO_SCORE_IMPROVEMENT.md) |
