...
| F07 | Backend API System | server | Completed / Database Activated | Checkpoint F07 dan F07E selesai. Database Prisma sudah menjadi sumber utama untuk website publik, fallback lokal telah dinonaktifkan. | (Selesai, lanjutkan iterasi selanjutnya) | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
