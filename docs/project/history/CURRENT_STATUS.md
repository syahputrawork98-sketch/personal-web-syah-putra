...
- **Struktur docs final**:
  ...
  - `docs/backend/`
  - `docs/database/`
- Tidak ada lagi folder lama `00`, `01`, `02`, `03` dan tidak ada lagi `docs/project/technical/`.
- Website publik tetap stabil.
- Backend, Auth, CV Final, Domain/Deployment, dan External Asset Links tetap HOLD (belum selesai/aktif).
