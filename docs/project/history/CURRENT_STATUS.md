...
| F07 | Backend API System | server | Partial / Blocked | Checkpoint F07, F07E selesai. Database Prisma sudah menjadi sumber utama, fallback lokal dinonaktifkan. Tahap F07F terblokir karena PostgreSQL lokal mati. | Hidupkan DB lokal untuk lanjut (F07F) | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
