...
| F07 | Backend API System | server | Partial / Structure Audited | Struktur server sudah diaudit, tetapi backend belum dijadikan sumber data utama | F07B — API Scope Definition | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
