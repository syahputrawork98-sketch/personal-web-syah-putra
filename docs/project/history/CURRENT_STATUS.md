...
| F08 | Admin Login and Auth System | backend/auth | Partial / Requirement Defined | Dokumen kebutuhan selesai, namun implementasi auth tetap HOLD karena backend belum aktif penuh. | F08B — Auth Flow Design | [F08_ADMIN_LOGIN_AUTH_SYSTEM.md](features/F08_ADMIN_LOGIN_AUTH_SYSTEM.md) |
