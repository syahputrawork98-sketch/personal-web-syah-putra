...
| F07 | Backend API System | server | Partial / Structure Audited | Struktur server dan scope API sudah diaudit, tetapi backend belum dijadikan sumber data utama. | F07D — Frontend Backend Connection Review | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
