...
| F05 | CV Download System | frontend/assets | Partial / Blocked | UI/QA siap, file PDF final hasil cetak browser belum tersedia. Sedang memakan fallback. | F05A — Final CV PDF Asset Preparation | [F05_CV_DOWNLOAD_SYSTEM.md](features/F05_CV_DOWNLOAD_SYSTEM.md) |
...
| F11 | CV Builder and PDF Export System | frontend/admin | Partial / Blocked | Logika *State Management* dan Cetak PDF mandiri (Browser) selesai (F11E.4). URL target download statis siap, menanti PDF diletakkan manual. | F11F — Final Handoff of static PDF | [F11_CV_BUILDER_PDF_EXPORT_SYSTEM.md](features/F11_CV_BUILDER_PDF_EXPORT_SYSTEM.md) |
