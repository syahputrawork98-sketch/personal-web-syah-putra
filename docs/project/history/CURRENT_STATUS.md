...
| F08 | Admin Login and Auth System | backend/auth | Partial / Auth Flow Designed | Dokumen kebutuhan dan desain alur auth selesai. Implementasi kode menunggu instruksi kelanjutan backend. | F08C — Protected Route Implementation | [F08_ADMIN_LOGIN_AUTH_SYSTEM.md](features/F08_ADMIN_LOGIN_AUTH_SYSTEM.md) |
