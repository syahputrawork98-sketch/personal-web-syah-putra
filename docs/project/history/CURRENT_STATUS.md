...
| F05 | CV Download System | frontend/assets | Partial | UI/QA siap, file PDF final belum tersedia | F05A — Final CV PDF Asset Preparation | [F05_CV_DOWNLOAD_SYSTEM.md](features/F05_CV_DOWNLOAD_SYSTEM.md) |
...
| F09 | Admin Content Management System | frontend/backend | Partial / CV Asset Link Reviewed | Modul operasional CMS telah dipetakan, prioritas ditentukan, dan sub-batch terdefinisi. F09D CV & Asset Link Management telah sinkron dan diselesaikan (QA). | F09E — Profile/Settings Management Module | [F09_ADMIN_CONTENT_MANAGEMENT_SYSTEM.md](features/F09_ADMIN_CONTENT_MANAGEMENT_SYSTEM.md) |
