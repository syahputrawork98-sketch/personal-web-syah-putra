...
| F12 | Learning Library System | frontend | In Progress | F12A (Public Static Page) sudah selesai. Integrasi CMS & Database belum. | F12C — Learning Library Admin CMS | [F12_LEARNING_LIBRARY_SYSTEM.md](features/F12_LEARNING_LIBRARY_SYSTEM.md) |
