...
| F07 | Backend API System | server | Completed / Database Setup Ready | Checkpoint F07, F07E, F07G selesai. Database Prisma menjadi sumber utama, fallback lokal dinonaktifkan, panduan docker-compose PostgreSQL tersedia. | Validasi database secara mandiri | [F07_BACKEND_API_SYSTEM.md](features/F07_BACKEND_API_SYSTEM.md) |
