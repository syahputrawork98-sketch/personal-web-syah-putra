...
| F11E | PDF Generation & Export Workflow | HOLD | Menyuntikkan CSS `@media print` dan mengirim hasil cetakan final ke backend `/api/admin/cv-builder/generate`. | F11E.1 |
