...
export const projectsFallback = [
  ...
  // ==========================================
  {
    ...
    impact: "Mengurangi waktu rekapitulasi data progres mingguan dari semula 3 hari menjadi hitungan menit secara otomatis, serta meminimalisir selisih laporan logistik di lapangan.",
  ...
  },
  {
    ...
    impact: "Meningkatkan skor performa Lighthouse ke kategori hijau (>90) dan berhasil mengotomatisasi notifikasi pemesanan langsung ke email tim operasional secara instan.",
  ...
  // ==========================================
  {
    ...
    impact: "Memangkas waktu penyusunan dokumen tender dan RAB hunian dari semula 5 hari kerja menjadi kurang dari 2 hari dengan tingkat presisi volume material di bawah margin error 2%.",
