        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-8)' }}>
            ...
            <nav style={{ display: 'flex', gap: 'var(--space-4)', flexWrap: 'wrap' }}>
              ...
              <Link to="/admin/education" style={{ textDecoration: 'none', color: 'var(--text-color)', opacity: 0.8 }}>Education</Link>
              <Link to="/admin/certifications" style={{ textDecoration: 'none', color: 'var(--text-color)', opacity: 0.8 }}>Certifications</Link>

              <Link to="/admin/settings/hero" style={{ textDecoration: 'none', color: 'var(--text-color)', opacity: 0.8 }}>Hero Settings</Link>
              <Link to="/admin/settings/profile" style={{ textDecoration: 'none', color: 'var(--text-color)', opacity: 0.8 }}>Profile Settings</Link>
